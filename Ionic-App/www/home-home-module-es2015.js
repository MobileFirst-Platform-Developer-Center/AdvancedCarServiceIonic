...
let HomePage = class HomePage {
    constructor(alertController, router, toastController, httpClient) {
        ...
        // this.httpClient.get('https://api.myjson.com/bins/7d7fc').subscribe(data => {
        this.httpClient
            // .get(
            //   'https://jsonblob.com/api/jsonBlob/73d244c2-5315-11ea-8e7b-3da7578b2e0a'
            // )
            .get(
        //  'https://jsonblob.com/api/jsonBlob/1967478e-53bb-11ea-a41b-b5f1e0b3474a'
    ...
    pushInit() {
        WLAuthorizationManager.obtainAccessToken("push.mobileclient").then((accessToken) => {
