...
/* harmony import */ var _add_user_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./add-user-routing.module */ "./src/app/add-user/add-user-routing.module.ts");
/* harmony import */ var _add_user_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./add-user.page */ "./src/app/add-user/add-user.page.ts");
...
AddUserPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _add_user_routing_module__WEBPACK_IMPORTED_MODULE_6__["AddUserPageRoutingModule"]
        ],
...
let AddUserPage = class AddUserPage {
    ...
    register(form) {
        ...
        // alert(this.user.date);
        // const body = {user: 'login', password: 'pass'};
        this.httpClient
            .post('http://localhost:3000/submit', this.user)
            .subscribe(data => {
            // this.items = data;
            // alert(data);
            // alert(this.today);
            ...
            this.router.navigate(['search'], {
                state: { example: "bar", myitems: data }
            });
...
AddUserPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-user.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/add-user/add-user.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-user.page.scss */ "./src/app/add-user/add-user.page.scss")).default]
    }),
